...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "task-consumer-impl";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:config:task-consumer:impl";
    private final String revision = "2014-05-23";
    private final String resourcePath = "/META-INF/yang/task-consumer-impl.yang";
