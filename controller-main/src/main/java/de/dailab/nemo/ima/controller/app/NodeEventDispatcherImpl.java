...
public class NodeEventDispatcherImpl implements OpendaylightInventoryListener {
    ...
    private Map<InstanceIdentifier<Node>, SwitchHandler> handlerMapping;
    ...
    public void onNodeUpdated(NodeUpdated nodeUpdated) {
    	 ...
    	 * 
    	 */
    	SwitchHandler nodeHandler = handlerMapping.get(nodeOfPacket);
    	 ...
    	 */
    	if (nodeHandler != null) {
    		nodeHandler.onNodeAppeared(nodeUpdated);
    	} else {
     ...
     */
    public Map<InstanceIdentifier<Node>, SwitchHandler> getHandlerMapping() {
