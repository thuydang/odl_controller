package org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.task.provider.impl.rev140523 ;
...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "task-provider-impl";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:config:task-provider:impl";
    private final String revision = "2014-05-23";
    private final String resourcePath = "/META-INF/yang/task-provider-impl.yang";
