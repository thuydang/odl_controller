...
/**
 * Class that builds {@link org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.task.provider.impl.rev140523.modules.module.configuration.task.provider.impl.NotificationService} instances.
 *
 * @see org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.task.provider.impl.rev140523.modules.module.configuration.task.provider.impl.NotificationService
 *
 */
public class NotificationServiceBuilder implements Builder <org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.task.provider.impl.rev140523.modules.module.configuration.task.provider.impl.NotificationService> {
    ...
    */
    ...
    @SuppressWarnings("unchecked")
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.task.provider.impl.rev140523.modules.module.configuration.task.provider.impl.NotificationService>> E getAugmentation(java.lang.Class<E> augmentationType) {
    ...
    public NotificationServiceBuilder addAugmentation(java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.task.provider.impl.rev140523.modules.module.configuration.task.provider.impl.NotificationService>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.task.provider.impl.rev140523.modules.module.configuration.task.provider.impl.NotificationService> augmentation) {
    ...
    public NotificationServiceBuilder removeAugmentation(java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.task.provider.impl.rev140523.modules.module.configuration.task.provider.impl.NotificationService>> augmentationType) {
    ...
    private static final class NotificationServiceImpl implements NotificationService {
        ...
        public java.lang.Class<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.task.provider.impl.rev140523.modules.module.configuration.task.provider.impl.NotificationService> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.task.provider.impl.rev140523.modules.module.configuration.task.provider.impl.NotificationService.class;
        }
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            if (!org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.task.provider.impl.rev140523.modules.module.configuration.task.provider.impl.NotificationService.class.equals(((DataObject)obj).getImplementedInterface())) {
                return false;
            }
            org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.task.provider.impl.rev140523.modules.module.configuration.task.provider.impl.NotificationService other = (org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.task.provider.impl.rev140523.modules.module.configuration.task.provider.impl.NotificationService)obj;
            if (_name == null) {
