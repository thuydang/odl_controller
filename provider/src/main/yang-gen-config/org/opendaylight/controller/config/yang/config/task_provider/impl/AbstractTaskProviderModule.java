...
public abstract class AbstractTaskProviderModule implements org.opendaylight.controller.config.spi.Module,org.opendaylight.controller.config.yang.config.task_provider.impl.TaskProviderModuleMXBean {
    private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(org.opendaylight.controller.config.yang.config.task_provider.impl.AbstractTaskProviderModule.class);
    ...
    private final AbstractTaskProviderModule oldModule;
    ...
    public AbstractTaskProviderModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver) {
    ...
    public AbstractTaskProviderModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver,AbstractTaskProviderModule oldModule,java.lang.AutoCloseable oldInstance) {
        this.identifier = identifier;
        this.dependencyResolver = dependencyResolver;
    ...
    public boolean canReuseInstance(AbstractTaskProviderModule oldModule){
    ...
    public boolean isSame(AbstractTaskProviderModule other) {
        if (other == null) {
    ...
    public boolean equals(Object o) {
        ...
        AbstractTaskProviderModule that = (AbstractTaskProviderModule) o;
